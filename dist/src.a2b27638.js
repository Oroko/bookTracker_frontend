...
document.addEventListener("DOMContentLoaded", function () {
  getBooks();
  var createBookForm = document.querySelector("#create-book");
...
var getBooks = function getBooks() {
  fetch(url).then(function (res) {
    ...
    books.data.map(function (book) {
      var newBook = new Book(book, book.attributes);
...
var createFormHandler = function createFormHandler(e) {
  e.preventDefault();
...
var postFetch = function postFetch(formData) {
  fetch(url, {
    method: "POST",
    headers: {
    ...
    var newBook = new Book(book, book);
    document.querySelector("#book-container").innerHTML += newBook.renderBook();
